...
function preload() {
  img = loadImage('assets/stop.png');
  img1 = loadImage('assets/right.png');
  img2 = loadImage('assets/left.png');
  img3 = loadImage('assets/up.png');
  treasureImg = loadImage('assets/treasure.png');
  openTreasureImg = loadImage('assets/open.png');

  Game = loadSound("assets/fundoGame.mp3");
  ...
  vida = loadImage('assets/hearth.png');
...
function draw() {
  ...
  fill('red');
  rect(500,10,life,9);
  image(vida, 1280, 0,  img.width*3, img.height*2); // Desenha a imagem no canvas
